<template>
  <div class="box">
    <!-- <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="address" label="菜单状态"><el-button type='primary'>启用</el-button> <el-button type='info'>禁用</el-button></el-table-column>
      <el-table-column prop="address" label="菜单操作"> <el-button type='primary'>编辑</el-button><el-button type='danger'>删除</el-button></el-table-column>
    </el-table> -->
    ...
    >
      ...
      <el-table-column prop="address" label="菜单操作">
        <template slot-scope="scope">
